...
aws --endpoint-url=http://localhost:4575 sns subscribe \
    ...
    --attributes '{"FilterPolicy":"{\"eventType\":[ \"OFFENDER-UPDATED\", \"EXTERNAL_MOVEMENT_RECORD-INSERTED\", \"ASSESSMENT_CHANGED\", \"OFFENDER_BOOKING-REASSIGNED\", \"OFFENDER_ALIAS-CHANGED\", \"OFFENDER_BOOKING-CHANGED\", \"OFFENDER_DETAILS-CHANGED\", \"BOOKING_NUMBER-CHANGED\", \"SENTENCE_CALCULATION_DATES-CHANGED\", \"IMPRISONMENT_STATUS-CHANGED\", \"D1_RESULT\"] }"}'
